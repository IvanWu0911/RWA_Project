...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (storedToken && storedUser) {
      ...
      const isDemo = user.username === 'investor' || user.username === 'technician' || user.username === 'banker' || user.username === 'test3' || user.username === 'test1' || user.username === 'test2';
  ...
  const login = (
    ...
    const isDemo = name === 'investor' || name === 'technician' || name === 'banker' || name === 'test3' || name === 'test1' || name === 'test2';
